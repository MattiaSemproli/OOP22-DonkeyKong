...
public class MainMenu implements GameEngine {
    ...
    private void createFuncButtons() {
        this.funcButtons[MenuAssets.playB] = new ButtonImpl(menuX + (MenuAssets.menuTextureBox - MenuAssets.buttonWidth) / 2, 
    ...
    private void createUtilityButtons() {
        ...
        this.utilityButtons[MenuAssets.quitB] = new ButtonImpl(menuX + MenuAssets.menuTextureBox - MenuAssets.buttonWidth - MenuAssets.menuTextureBox / 12, 
                                                               menuY + MenuAssets.menuTextureBox - MenuAssets.buttonHeight - MenuAssets.menuTextureBox / 8, 
